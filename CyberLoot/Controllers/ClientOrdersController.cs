...
namespace CyberLoot.Controllers
{
    ...
    public class ClientOrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pageIndex)
        {
            ...
            IQueryable<Order> query = context.Order.Include(o => o.Items).OrderByDescending(o => o.Id).Where(o => o.ClientId == currentUser.Id);
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var order = context.Order.Include(o => o.Items)
