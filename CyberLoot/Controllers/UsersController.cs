...
namespace CyberLoot.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            IQueryable<ApplicationUser> query = userManager.Users.OrderByDescending(u => u.JoinedOn);
        ...
        public async Task<IActionResult> Details(string? id)
        {
            ...
            // get all available roles, prepares select list
        ...
        public async Task<IActionResult> EditRole(string? id, string? newRole)
        {
            ...
            // stops current user from changing their own role.
            if (currentUser!.Id == appUser.Id)
            {
                TempData["ErrorMessage"] = "You cannot update you own role!";
            ...
            TempData["SuccessMessage"] = "User Role was updated successfully!";
            return RedirectToAction("Details", "Users", new { id });
        }
        ...
        { 
            ...
            var currentUser = await userManager.GetUserAsync(User);
            // stops user from deleting their own account.
            if (currentUser!.Id == appUser.Id)
            {
