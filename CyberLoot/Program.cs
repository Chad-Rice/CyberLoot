...
builder.Services.AddScoped<WishlistHelper>();
...
{
    options.IdleTimeout = TimeSpan.FromSeconds(30); // sets the sessions timeout
...
// create the roles for the first admin user if they aren't available yet
