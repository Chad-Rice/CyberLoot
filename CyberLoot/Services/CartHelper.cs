...
namespace CyberLoot.Services
{
    ...
    {
        // get cart items from cart cookie and convert to dictionary, allows for fast look up
        public static Dictionary<int, int> GetCartDictionary(HttpRequest request, HttpResponse response) // Dictionary = list of pairs, int orderId, int quantity
        {
            ...
            {
                // this cookie isn't valid => it's deleted 
        ...
        internal static decimal GetSubtotal(List<Order> cartItems)
        {
